...
public class GeoLocationUtils {
     ...
     public static final double LAT_SOUTH = 37.711940;
 
     // area width and height
     public static final double LON_WIDTH = (LON_WEST*-1) - LON_EAST;
     public static final double LAT_HEIGHT = LAT_NORTH - LAT_SOUTH;
 
     // delta step to create artificial grid overlay of SF
      ...
      * area of SF. The grid cells are roughly 100 x 100 m and sequentially number from north-west
      ...
      * cells of a grid covering the area of SF. The grid cells are roughly 100 x 100 m and
